...
Write a clean professional proposal. Use the company name as the heading, not the words "Contractor Proposal". Include: contractor contact info at the top, today's date, client name and address, intro paragraph, scope of work, pricing, timeline, payment terms (50% upfront 50% on completion), 30 day validity clause, and a closing signature block with the contractor's name, title, phone and email. Plain text only, no markdown, no asterisks.`;
